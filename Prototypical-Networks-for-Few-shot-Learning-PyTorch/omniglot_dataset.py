...
class OmniglotDataset(data.Dataset):
    ...
    def __init__(self, mode='train', root='..' + os.sep + 'dataset', transform=None, target_transform=None, download=False, data_exist=True):
        '''
    ...
    def raw_to_data(self):
        ...
        for p in ['images_background', 'images_evaluation']:
            # print(os.listdir(os.path.join(orig_root, p)))

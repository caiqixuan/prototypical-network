...
from src.util import FlexDataRead
from src.util import PictureDataRead
...
def init_dataset(opt, mode):
    ...
    if mode == 'train':
        print('training')
        dataset = PictureDataRead.FlexSensorDataReadTestFunction()
    if mode == 'test':
        dataset = FlexDataRead.FlexSensorDataReadTestFunction()
    # print(dataset.y[5])
    # print(dataset[5][1])
...
def main():
    ...
    '''
    ### 取出参数
    options = get_parser().parse_args(['-cTr','3','-its','300','-nsTr','20'])
    # print(options)
...
if __name__ == '__main__':
    # MNIST_ROOT = r'D:\DAstudy\FastMDL-main\baselines\Prototypical-Networks-for-Few-shot-Learning-PyTorch\dataset\minist'
    # dataroot = r'D:\DAstudy\FastMDL-main\baselines\Prototypical-Networks-for-Few-shot-Learning-PyTorch\dataset'
    main()
